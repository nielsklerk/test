...
settings_img = pygame.transform.scale(settings_img, (settings_img.get_width() * 1.4, settings_img.get_height() * 1.4))
...
inventory_btn_img = pygame.transform.scale(inventory_btn_img, (inventory_btn_img.get_width() * 1.4, inventory_btn_img.get_height() * 1.4))
